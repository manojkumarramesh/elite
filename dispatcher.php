...
/* BCSE Begin - Xmall */
if(!empty($active_modules['BCSE_Xmall']) && !empty($xmall_store_info) && $xmall_store_info['config']['domain'] == ''){
	$dispatched_request = preg_replace('/^' . $xmall_store_info['directory'] . '\//i','',$dispatched_request);
}
/* BCSE End */
