 ...
 *
 * @author John Gadbois - DomainSuperstar.com
 */
...
class WordStream {
    ...
    public function login()
    {
        ...
        {
            echo 'Error : login'."<br/>";
            echo 'Response : '.$response->code."<br/>";
            return false;
        }
        else
        {
    ...
    public function getKeywords($seeds, $maxResults = 100)
    {
        ...
        if($response->code != 'OK')
        {
            echo 'Error : getKeywords'."<br/>";
            echo 'Response : '.$response->code."<br/><br/>";
            return false;
        }
        else
        {
    ...
    public function getRelatedKeywords($seeds, $maxResults = 100)
    {
        ...
        if($response->code != 'OK')
        {
            echo 'Error : getRelatedKeywords'."<br/>";
            echo 'Response : '.$response->code."<br/>";
            return false;
        }
        else
    ...
    public function getQuestionKeywords($seeds, $maxResults = 100)
    {
        ...
        if($response->code != 'OK')
        {
            echo 'Error : getQuestionKeywords'."<br/>";
            echo 'Response : '.$response->code."<br/>";
            return false;
        }
        else
    ...
    public function getKeywordNiches($seeds, $maxResults = 100)
    {
        ...
        if($response->code != 'OK')
        {
            echo 'Error : getKeywordNiches'."<br/>";
            echo 'Response : '.$response->code."<br/>";
            return false;
        }
        else
    ...
    public function getKeywordVolumes($seeds)
    {
        $response = $this->callAPI('keywordtool/get_keyword_volumes', array(keywords => $seeds, session_id => $this->session));

        if($response->code != 'OK')
        {
            echo 'Error : getKeywordVolumes'."<br/>";
            echo 'Response : '.$response->code."<br/>";
            return false;
        }
        else
