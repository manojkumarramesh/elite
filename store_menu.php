...
{
    $sql    =   "SELECT categoryid, category FROM xcart_categories WHERE parentid = ".$categoryid." AND avail = 'Y'";
...
$sql    =   "SELECT categoryid, category FROM xcart_categories WHERE parentid = 0 AND avail = 'Y'";
$result =   func_query($sql, USE_SQL_DATA_CACHE);
...
//$smarty->assign('categories_menu_list', $array);